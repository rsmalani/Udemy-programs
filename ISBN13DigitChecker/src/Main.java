...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (remainder1 == 0)
                System.out.println(Console_Colors.RED_BOLD_BRIGHT + "The given ISBN number is valid.");
            else
                System.out.println(Console_Colors.BLUE_BOLD_BRIGHT + "The given ISBN number is invalid.");
